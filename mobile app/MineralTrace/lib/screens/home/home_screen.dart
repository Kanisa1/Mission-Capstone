...
class _HomeScreenState extends State<HomeScreen> {
            ...
            children: [
              LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  final navSize = isCompactHeader ? 34.0 : 40.0;
                  final navIconSize = isCompactHeader ? 19.0 : 22.0;

                  final brand = Row(
                    children: [
                      Container(
                        width: isCompactHeader ? 32 : 36,
                      ...
                      Expanded(
                        child: FittedBox(
                          ...
                          child: Text(
                            'mineralTrace',
                            style: TextStyle(
                              fontSize: isCompactHeader ? 23 : 31,
                              fontWeight: FontWeight.w700,
                              color: Colors.white,
                            ),
                          ),
  ...
  Widget _buildFeaturedCard() {
    ...
    final isCompactShowcase = screenWidth < 420;
          ...
          Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(
                    child: _buildFeaturedImage(double.infinity, imageHeight),
                  ),
                  SizedBox(width: isCompactShowcase ? 8 : 12),
                  Expanded(
                    child: _buildAppExplanationCard(
                      height: imageHeight,
                      compact: isCompactShowcase,
                    ),
                  ),
                ],
              ),
  ...
  Widget _buildAppExplanationCard({double? height, bool compact = false}) {
    return Container(
      height: height,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: compact ? 8 : 12),
            _buildFeatureItem(
              'Capture mineral images quickly',
              compact: compact,
            ),
            SizedBox(height: compact ? 6 : 8),
            _buildFeatureItem(
              'Analyze confidence and verification status',
              compact: compact,
            ),
            SizedBox(height: compact ? 6 : 8),
            _buildFeatureItem(
              'Track results with recent scan history',
              compact: compact,
            ),
          ],
        ),
