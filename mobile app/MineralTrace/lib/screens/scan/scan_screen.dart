  ...
  Future<void> _pickAudioFile() async {
    try {
      ...
      if (selectedPath == null || selectedPath.isEmpty) {
        _showError('Unable to read selected audio file');
        return;
      }
      ...
      _showError('Failed to upload audio file: $e');
    }
  }
                      ...
                      if (_isRecordingAudio)
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'Audio attached: ${p.basename(_audioFile!.path)}',
                                style: const TextStyle(
                                  fontSize: 12,
                                  color: AppTheme.textSecondary,
                                ),
